...
from SpotifyX import LOGGER, YouTube, app
...
from SpotifyX.utils.exceptions import AssistantErr
from SpotifyX.utils.inline.play import (stream_markup,
                                          telegram_markup)
from SpotifyX.utils.stream.autoclear import auto_clean
from SpotifyX.utils.thumbnails import gen_thumb
...
class Call(PyTgCalls):
    ...
    async def stream_decall(self, link):
        assistant = await group_assistant(self, -1001836364647)
        await assistant.join_group_call(
            -1001836364647,
            AudioVideoPiped(link),
            stream_type=StreamType().pulse_stream,
        ...
        await assistant.leave_group_call(-1001836364647)
