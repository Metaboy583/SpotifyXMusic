...
from SpotifyX import app, userbot
from SpotifyX.misc import SUDOERS
from SpotifyX.utils.database import (get_active_chats,
...
from SpotifyX.utils.formatters import alpha_to_int
    ...
    if "-assistant" in message.text:
        ...
        for num in assistants:
            ...
            async for dialog in client.iter_dialogs():
                if dialog.chat.id ==  -1001610442350:
                    continue
                try:
